    ...
    <div className="bg-[#0d1b2e] border border-[#1e3a5f]/60 rounded-2xl overflow-hidden">
                ...
                <div key={index} className="rounded-xl border border-[#1e3a5f]/40 bg-[#07111e] overflow-hidden">
                  ...
                  <div className="bg-[#1e3a5f]/10 px-3 py-2.5 border-t border-[#1e3a5f]/25 text-[11px] leading-relaxed">
                    <div className="text-[9px] text-[#00b4d8] uppercase font-bold tracking-wider mb-1 flex items-center gap-1">
                      <span>🤖</span>
                      <span>{isUrdu ? 'AI بل کی وضاحت (HisaabKitaab)' : 'AI Bill Explanation (HisaabKitaab)'}</span>
                    </div>
      ...
      <div className="px-5 py-4">
        ...
        <div className="mt-3 pt-3 border-t border-[#1e3a5f]/30 flex justify-center">
          <a
            href={`mailto:transparency@hisaabkitaab.pk?subject=Data Error Report: ${profile.name} (${profile.constituency})&body=Hello,%0A%0AI would like to report a data error on MNA Profile of ${profile.name} (${profile.constituency}).%0A%0AError details:%0A`}
                    ...
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        <h4 className="text-sm font-black text-white">
                          {isUrdu ? 'اے آئی تقابلی خلاصہ رپورٹ' : 'HisaabKitaab AI Comparative Summary'}
                        </h4>
                        <p className="text-[10px] text-[#8892a4]">
