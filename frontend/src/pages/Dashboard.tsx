    ...
    <div className="space-y-8">
      ...
      >
        ...
        <h3 className="text-lg font-bold text-white flex items-center gap-2 mb-4">
          ...
          <span className="text-xs px-2 py-0.5 rounded-full bg-red-500/10 text-red-400 font-normal">Auto-Scan</span>
        </h3>
      ...
      >
        ...
        {selectedReportCity && (
          <div id="city-report-card" className="p-6 rounded-xl border border-indigo-500/30 bg-[#0d1b2e] text-white space-y-4 max-w-lg mx-auto relative shadow-2xl">
            <div className="absolute top-2 right-2 text-[9px] font-bold text-indigo-400 uppercase tracking-widest">WakalaLens</div>
            ...
            <div className="pt-2 flex justify-between items-center text-[9px] text-[#5a6a7e]">
              <span>#WakalaLensPakistan</span>
              <span>transparency.budgetlens.pk</span>
            </div>
          </div>
        )}
